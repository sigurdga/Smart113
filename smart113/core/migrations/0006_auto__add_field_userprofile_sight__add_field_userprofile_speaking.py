...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.sight'
        db.add_column('core_userprofile', 'sight',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.speaking'
        db.add_column('core_userprofile', 'speaking',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.sight'
        db.delete_column('core_userprofile', 'sight')

        # Deleting field 'UserProfile.speaking'
        db.delete_column('core_userprofile', 'speaking')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'speaking': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
