...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.speaking'
        db.alter_column('core_userprofile', 'speaking', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.speaking'
        db.alter_column('core_userprofile', 'speaking', self.gf('django.db.models.fields.NullBooleanField')(null=True))
