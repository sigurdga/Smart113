...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.hearing'
        db.alter_column('core_userprofile', 'hearing', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'UserProfile.mobility'
        db.alter_column('core_userprofile', 'mobility', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.hearing'
        db.alter_column('core_userprofile', 'hearing', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'UserProfile.mobility'
        db.alter_column('core_userprofile', 'mobility', self.gf('django.db.models.fields.NullBooleanField')(null=True))
