...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserProfile.primary_language'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.primary_language' and its values cannot be restored.")
