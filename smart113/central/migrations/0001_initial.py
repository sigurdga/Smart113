...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Search'
        db.create_table('central_search', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('from_backend', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('query', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('central', ['Search'])


    def backwards(self, orm):
        # Deleting model 'Search'
        db.delete_table('central_search')
